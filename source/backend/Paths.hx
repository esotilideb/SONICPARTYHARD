...
class Paths
{
	...
	public static var dumpExclusions:Array<String> = ['flash/shared/music/freakyMenu.$SOUND_EXT'];
	...
	inline static function getLibraryPathForce(file:String, library:String, ?level:String)
	{
		...
		var returnPath = '$library:flash/$level/$file';
		return returnPath;
	}

	inline public static function getSharedPath(file:String = '')
	{
		return 'flash/shared/$file';
	}
	...
	static public function video(key:String)
	{
		...
		#end
		return 'flash/videos/$key.$VIDEO_EXT';
	}
